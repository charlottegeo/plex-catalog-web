          ...
          <div className="col-md-4 col-lg-3 mb-4 mb-md-0">
            {posterImageUrl ? (
              <img
                src={posterImageUrl}
                alt={details.title}
                className="img-fluid rounded shadow-lg details-poster"
              />
            ) : (
              ...
              {details.availableOn.map((server) => {
                ...
                return (
                  <tr key={server.serverId}>
                    <td data-label="Server" className="font-weight-bold">
                      {server.serverName}
                    </td>
                    <td data-label="Resolution">
                      {server.versions.map((version, index) => (
                        <span
                          key={index}
                          className="badge badge-soft-secondary mr-1"
                        >
        ...
        {details.itemType === 'show' && (
          <div>
            {details.availableOn.map((server) => (
              <div
                key={server.serverId}
                className="card server-details-card mb-4"
              >
